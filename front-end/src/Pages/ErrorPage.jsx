            ...
            <div class="absolute">
              <div class="">
                <h1 class="my-2 text-gray-800 font-bold text-2xl">
                  Whoops-a-daisy! Looks like you slipped into the wrong isle
                </h1>
                <p class="my-2 text-gray-800">
                  {" "}
                  No need to fret! We're currently tidying up and cooking up
                  some new recipes. While we're at it, why not take a look
                  around and discover some of our other tasty options? Keep an
                  eye out for more delicious culinary treats coming your way!{" "}
                </p>
                <button
