...
const SignUpPage = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (
      ...
      alert(
        "Password must be at least 8 characters long, include a special character, and not contain any whitespace characters."
      );
      return;
    }
              ...
              <input
                ...
                onChange={(e) => {
                  if (e.target.value.includes(" ")) {
                    setPasswordMessage([
                      "No whitespace characters allowed in password.",
                    ]);
                  } else if (
